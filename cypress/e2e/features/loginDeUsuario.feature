...
Quando preencher o e-mail e senhas válidas
E executar o login
...
E executar o login
Então o sistema exibirá a mensagem de erro no email "Informe o e-mail"
E o usuário não será logado
...
E executar o login
Então o sistema exibirá a mensagem de erro na senha "Informe a senha"
E o usuário não será logado
